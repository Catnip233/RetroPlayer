...
//!WIDTH OUTPUT.w
//!HEIGHT OUTPUT.h
//!DESC RetroPlayer Kurozumi BVM Style

// Parameters
#define HARD_SCAN -7.5
#define CURVATURE vec2(0.0, 0.0)
#define MASK_DARK 0.58
#define MASK_LIGHT 1.42
#define SHADOW_MASK 2
#define BRIGHTNESS_BOOST 1.12
#define HARD_BLOOM_SCAN -2.0
#define BLOOM_AMOUNT (1.0/20.0)
#define SHAPE 2.0
...
vec4 hook() {
	...
	vec4 effected = in_bounds * delinearize(vec4(color, source.a));
	return mix(source, effected, 0.3);
}
